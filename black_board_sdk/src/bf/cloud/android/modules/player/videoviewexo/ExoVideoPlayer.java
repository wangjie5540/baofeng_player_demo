 ...
 */
public class ExoVideoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     */
    void buildRenderers(ExoVideoPlayer player, RendererBuilderCallback callback);
  }
  ...
  public interface RendererBuilderCallback {
     ...
     *
     * @param trackNames The names of the available tracks, indexed by {@link ExoVideoPlayer} TYPE_*
     ...
     *     indexed by {@link ExoVideoPlayer} TYPE_* constants. May be null if there are no types with
  ...
  public ExoVideoPlayer(RendererBuilder rendererBuilder) {
    ...
    player = ExoPlayer.Factory.newInstance(RENDERER_COUNT, 0, 1000);
  ...
  private class InternalRendererBuilderCallback implements RendererBuilderCallback {
    ...
    public void onRenderers(String[][] trackNames, MultiTrackChunkSource[] multiTrackSources,
        TrackRenderer[] renderers) {
      if (!canceled) {
        ExoVideoPlayer.this.onRenderers(trackNames, multiTrackSources, renderers);
      }
    }
    ...
    public void onRenderersError(Exception e) {
      if (!canceled) {
        ExoVideoPlayer.this.onRenderersError(e);
      }
    }
